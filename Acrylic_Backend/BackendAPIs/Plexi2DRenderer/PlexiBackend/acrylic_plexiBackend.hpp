...
namespace Plexi {
    ...
    //Instance Vars
    template<typename T>//I was going to do this with
    static std::map<Plexi::PLEXI_GFX_BACKENDS, T*> GFXBackendMap = {{Plexi::PLEXI_NULL_BACKEND, nullptr}, {Plexi::PLEXI_VULKAN, new Vulkan()}};
